...
export const products: ProductCategory[] = [
  ...
  // -----------------------------------------------------------------------------
  {
    ...
    features: [
      ...
      { text: "MOQ 100–200 pieces per style" },
      { text: "18–35 days production lead time" },
    ...
    popularItems: [
      ...
      "Ploy Jersey Knit Top",
      "Bias-Cut Satin Midi Skirt",
      "Cotton Voile Summer Dress",
      "Tailored Wide-Leg Trousers",
    ],
    leadTime: "18–35 days",
    moq: "100–200 pcs / style",
    targetAudience: "Fashion brands, boutique owners, sustainable fashion labels, resort wear brands",
    fabricOptions: [
      "100% Cotton",
      "Organic Cotton (GOTS certified)",
      "100% European Linen",
    ...
    certifications: ["BSCI", "OEKO-TEX® Standard 100", "SEDEX", "WRAP", "GOTS"],
    specs: {
      fabricWeight: "110–200 GSM depending on fabric type",
      construction: "Woven & knit construction available",
      sizing: "XS–XXL (custom grading available)",
      finishing: [
        "Pantone-matched dyeing",
        "Screen printing",
        "Hand batik wax-resist dyeing",
        "Embroidery",
        "Lace & trim application",
      ],
    },
    faqs: [
      {
  ...
  // -----------------------------------------------------------------------------
  {
    ...
    features: [
      ...
      { text: "OEKO-TEX® Standard 100 certified fabrics available" },
      { text: "MOQ 100–200 pieces per style" },
      { text: "18–32 days production lead time" },
    ...
    popularItems: [
      ...
      "Tailored Linen Formal Trousers",
      "Cotton Oxford Casual Shirt",
      "Slim-Fit Chino Trousers",
    ],
    leadTime: "18–32 days",
    moq: "100–200 pcs / style",
    targetAudience: "Fashion brands, corporate uniform buyers, e-commerce retailers, department stores",
    fabricOptions: [
      "100% Cotton Poplin",
      "Oxford Cotton",
      "100% European Linen",
      "Cotton-Nylon Twill",
      "Polyester-Spandex Performance",
      "Recycled Polyester",
    ],
    certifications: ["BSCI", "OEKO-TEX® Standard 100", "SEDEX", "WRAP", "GRS"],
    specs: {
      fabricWeight: "120–280 GSM depending on garment type",
      construction: "Woven and knit construction available",
      sizing: "S–3XL (custom grading available)",
      finishing: [
  ...
  // -----------------------------------------------------------------------------
  {
    ...
    features: [
      ...
      { text: "MOQ 150–200 pieces per style" },
      { text: "18–32 days production lead time" },
    ...
    popularItems: [
      ...
      "School Uniform Set (Boys)",
      "Ruffle Tiered Maxi Dress",
      "Boys' Graphic Tee & Shorts Set",
      "Girls' Cotton Knit Dress",
    ],
    leadTime: "18–32 days",
    moq: "150–200 pcs / style",
    targetAudience: "Children's clothing brands, school uniform suppliers, sustainable kids' fashion labels, retailers",
    fabricOptions: [
      "100% GOTS-certified Organic Cotton",
      "OEKO-TEX® Standard 100 Cotton",
      "Cotton-Spandex Jersey",
      "Cotton-Nylon Twill (for uniforms)",
      "Recycled Polyester",
      "Cotton Voile",
    ],
    certifications: ["BSCI", "OEKO-TEX® Standard 100", "SEDEX", "WRAP", "GOTS"],
    specs: {
      fabricWeight: "110–200 GSM depending on garment type",
      construction: "Woven and knit construction available",
      sizing: "2T–14T (size chart provided)",
      finishing: [
        "Screen printing",
        "Embroidery",
        "Rubber print",
        "Heat transfer",
        "School crest embroidery",
      ],
    },
    faqs: [
      {
