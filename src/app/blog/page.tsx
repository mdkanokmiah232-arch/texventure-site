...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Expert articles on garment manufacturing, apparel sourcing, MOQs, pricing, and the fashion supply chain — by the TexVenture team.',
  alternates: {
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1B2A4A] via-[#1e3357] to-[#0f2240]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 text-center sm:py-24 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-300">
            Industry insights, manufacturing guides, and sourcing tips from the
            TexVenture team.
          </p>
        </div>
      </section>
