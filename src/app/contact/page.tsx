...
const contactMethods = [
  {
    ...
    value: '+880 135 4316246',
    href: 'https://wa.me/8801354316246?text=Hi!%20I%20am%20interested%20in%20sourcing%20apparel.%20Can%20you%20help?',
    icon: (
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <aside className="space-y-8">
            ...
            {/* WhatsApp CTA */}
            <div className="rounded-2xl bg-[#25D366] p-6 text-center">
